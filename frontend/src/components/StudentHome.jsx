...
//             <strong className="font-semibold text-gray-800">submit your answers</strong>, participate in live
...
//             <label htmlFor="name" className="block text-sm font-medium text-left text-gray-800">
//               Enter your Name
//             </label>
//             <div className="mt-2">
//               <input
...
//                 className="block w-full border-none bg-[#6e6e6e]/10 py-3 px-4 text-gray-900 shadow-sm  sm:text-sm"
//               />
//             </div>
//             <button
//               type="submit"
//               onClick={() => window.location.href = '/student-vote'}
//               className="relative left-[30%] mt-6 rounded-full bg-gradient-to-r from-[#816FE7] to-[#6366F1] py-3 px-8 text-sm font-semibold text-white shadow-sm hover:scale-105 transition-transform disabled:opacity-50 w-[40%]"
//             >
//               Continue
//             </button>
//           </div>
